...
var tablesSurface = /** @class */ (function (_super) {
    ...
    tablesSurface.prototype.go = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, res, req, _b, yuanName, name, describe, tables, key;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this, res = _a.res, req = _a.req;
                        _b = req.query, yuanName = _b.yuanName, name = _b.name, describe = _b.describe;
                        return [4 /*yield*/, query({ sql: "rename table " + yuanName + " to " + name, res: res })];
                    case 1:
                        tables = _c.sent();
                        return [4 /*yield*/, query({ sql: "alter table " + name + " comment '" + describe + "';", res: res })];
                    case 2:
                        _c.sent();
                        key = {};
                        res.send({
