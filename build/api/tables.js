...
var tables = /** @class */ (function (_super) {
    ...
    tables.prototype.go = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, res, req, tables, key, database, _b, _c, _i, v, _d, _e;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        _a = this, res = _a.res, req = _a.req;
                        return [4 /*yield*/, query({ sql: "show tables", res: res })];
                    case 1:
                        tables = _f.sent();
                        key = {};
                    ...
                    case 2:
                        ...
                        v = _b[_i];
                        _d = key;
                        _e = tables[v]["Tables_in_" + database];
                        return [4 /*yield*/, query({ sql: "show full columns from " + tables[v]["Tables_in_" + database], res: res })];
                    case 3:
                        _d[_e] = _f.sent();
                        _f.label = 4;
                    case 4:
...
module.exports = function (req, res) { return new tables(req, res); };
